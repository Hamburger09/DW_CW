...
st.markdown("""
<style>
@import url('https://fonts.googleapis.com/css2?family=IBM+Plex+Sans:wght@300;400;500;600&family=IBM+Plex+Mono:wght@300;400&display=swap');
...
[data-testid="stDownloadButton"] > button:hover {
    opacity: 1;
    background: rgba(93,187,170,0.08) !important;
}
...
[data-testid="stNumberInput"] input:focus {
    border-color: var(--accent) !important;
    box-shadow: 0 0 0 2px rgba(123,147,255,0.1) !important;
}
...
/* ── Alert boxes ── */
[data-testid="stInfo"] {
    background: rgba(123,147,255,0.06) !important;
    border: 1px solid rgba(123,147,255,0.2) !important;
    border-radius: var(--radius) !important;
}
[data-testid="stSuccess"] {
    background: rgba(93,187,170,0.06) !important;
    border: 1px solid rgba(93,187,170,0.2) !important;
    border-radius: var(--radius) !important;
}
[data-testid="stWarning"] {
    background: rgba(224,176,80,0.06) !important;
    border: 1px solid rgba(224,176,80,0.2) !important;
    border-radius: var(--radius) !important;
}
[data-testid="stError"] {
    background: rgba(224,112,112,0.06) !important;
    border: 1px solid rgba(224,112,112,0.2) !important;
    border-radius: var(--radius) !important;
}
...
[data-testid="stMultiSelect"] span[data-baseweb="tag"] {
    background: rgba(123,147,255,0.1) !important;
    border: 1px solid rgba(123,147,255,0.3) !important;
